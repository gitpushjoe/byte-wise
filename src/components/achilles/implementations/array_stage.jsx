		...
		arrItem1.distribute(
			[
				[
					{ 
						property: 'centerY',
						duration: this.stretchTime(5),
						from: null,
						to: y => y + Constants.ARR_ITEM_SIZE + Constants.ARR_ITEM_MARGIN,
					},
					{
						property: 'centerX',
						duration: this.stretchTime(8),
						from: null,
						to: x2,
					},
					{
